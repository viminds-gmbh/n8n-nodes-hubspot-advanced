...
**URL:** `https://api.hubapi.com/crm/v3/objects/0-410?after=<string>&archived=false&associations=<string>&associations=<string>&limit=10&properties=<string>&properties=<string>&propertiesWithHistory=<string>&propertiesWithHistory=<string>`
...
**Description:** Archive a batch of objects
...
### Read a batch of courses by internal ID, or unique property values

**Method:** `POST`

**URL:** `https://api.hubapi.com/crm/v3/objects/0-410/batch/read?archived=false`
...
### Create or update a batch of courses by unique property values
...
**Description:** Fetch objects using a search query
...
**URL:** `https://api.hubapi.com/crm/v3/objects/0-410/:courseId?archived=false&associations=<string>&associations=<string>&idProperty=<string>&properties=<string>&properties=<string>&propertiesWithHistory=<string>&propertiesWithHistory=<string>`
...
**URL:** `https://api.hubapi.com/crm/v3/objects/0-410/:courseId`
...
**URL:** `https://api.hubapi.com/crm/v3/objects/0-410/:courseId?idProperty=<string>`
