...
**URL:** `https://api.hubapi.com/crm/v3/objects/0-162?after=<string>&archived=false&associations=<string>&associations=<string>&limit=10&properties=<string>&properties=<string>&propertiesWithHistory=<string>&propertiesWithHistory=<string>`
...
**URL:** `https://api.hubapi.com/crm/v3/objects/0-162/batch/read?archived=false`
...
**Description:** Fetch objects via a search query
...
**URL:** `https://api.hubapi.com/crm/v3/objects/0-162/:serviceId?archived=false&associations=<string>&associations=<string>&idProperty=<string>&properties=<string>&properties=<string>&propertiesWithHistory=<string>&propertiesWithHistory=<string>`
...
**URL:** `https://api.hubapi.com/crm/v3/objects/0-162/:serviceId`
...
**URL:** `https://api.hubapi.com/crm/v3/objects/0-162/:serviceId?idProperty=<string>`
