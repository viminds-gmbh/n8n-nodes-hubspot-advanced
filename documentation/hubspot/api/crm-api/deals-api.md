...
**URL:** `https://api.hubapi.com/crm/v3/objects/0-3?after=<string>&archived=false&associations=<string>&associations=<string>&limit=10&properties=<string>&properties=<string>&propertiesWithHistory=<string>&propertiesWithHistory=<string>`
...
**URL:** `https://api.hubapi.com/crm/v3/objects/0-3/batch/read?archived=false`
...
**URL:** `https://api.hubapi.com/crm/v3/objects/0-3/:dealId?archived=false&associations=<string>&associations=<string>&idProperty=<string>&properties=<string>&properties=<string>&propertiesWithHistory=<string>&propertiesWithHistory=<string>`
...
**URL:** `https://api.hubapi.com/crm/v3/objects/0-3/:dealId?idProperty=<string>`
